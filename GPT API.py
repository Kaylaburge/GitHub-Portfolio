...
# this block is going through my current working directory to find the data file used with the prompt
os.getcwd()
os.chdir("/Users/kaylaburge/Downloads") 
load_dotenv(find_dotenv())

# load_dotenv()
# This block is opening the Chat GPT environment.
OPENAI_API_KEY=os.environ.get('OPENAI_API_KEY')
print(OPENAI_API_KEY)

# This block opens my personal API Key here that I bought from OpenAI
from openai import OpenAI 
client=OpenAI()

# This block sends a request to ChatGPT like you normally would with just a written prompt.
...
# This block of code prints the Chat GPT output that would normally print in the web interface.
